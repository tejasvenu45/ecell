...
//         <div className="flex flex-row items-center gap-8 md:gap-20 ml-8 md:ml-20">
//           <p className="hover:text-gray-300 cursor-pointer">Home</p>
//           <div className="btn hover:text-gray-300 cursor-pointer">Events</div>
//           <p className="hover:text-gray-300 cursor-pointer">About Us</p>
//           <p className="hover:text-gray-300 cursor-pointer">Articles</p>
//           <p className="hover:text-gray-300 cursor-pointer">Quiz</p>
//         </div>
//         <img src={navImage} alt="Navbar Image" className="h-16 md:h-20 mr-8 md:mr-20" />
//       </div>
//       <div></div>
//     </>
//   );
...
//     <>
//       <div className="flex flex-col md:flex-row items-center justify-between w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-4 md:py-6">
//         <div className="flex flex-row items-center justify-center gap-8 md:gap-20 ml-8 md:ml-20">
